      ...
      <div class="single-schedule">
        ...
        <div class="single-schedule-content">
          ...
          <ul class="schedule-proposals single-prop">
            <li v-for="item in 6" class="schedule-proposals__item col-3">
...
export default {
  ...
  beforeMount() {
    this.$store.commit('setSingleMoviePage');
  },
  beforeDestroy() {
    this.$store.commit('removeSingleMoviePage');
  },
  components: {
    DropdownMenu,
  }
